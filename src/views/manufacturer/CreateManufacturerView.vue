...
const handleSubmit = async () => {
  ...
  await router.push(`/manufacturer/${manufacturerResponse.manufacturer_name}`) // Re-routes the user to the manufacturer view page - displays newly created manufacturer
}
</script>
